...
const { createUser, loginUser, logOut, forgetPassword, ResetPassword, getUserProfile, updatePassword, updateProfile, allUsers, getUserDetail, updateUser, deleteUser } = require('../Controllers/AuthControllers');
